        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#fa-icons2" @click="tabTitle($event, 0)">Font Awesome</a></li>
              <li class=""><a href="#glyphicons2" @click="tabTitle($event, 1)">Glyphicons</a></li>
            </ul>
...
export default {
    methods: {
        tabTitle(e, idx) {
            closest(e.target, "ul").querySelector(".active").classList.remove("active");
            closest(e.target, "li").classList.add("active");

            let panes = closest(e.target, ".nav-tabs-custom").querySelectorAll(".tab-pane")
