...
<script>
  ...
  $(function () { // onload event 대체.
    ...
    var areaChartCanvas = querySelector("#areaChart").getContext('2d')
    ...
    var lineChartCanvas          = querySelector('#lineChart').getContext('2d')
    ...
    var pieChartCanvas = querySelector('#pieChart').getContext('2d')
    ...
    var barChartCanvas                   = querySelector('#barChart').getContext('2d')
